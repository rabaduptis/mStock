        ...
        binding.buttonAdd.setOnClickListener {
            ...
            val productEntity =
                ProductEntity(
                    ...
                    uniqueId = null,
                    binding.editTextProductName.toString(),
                    binding.editTextEan.toString(),
                    binding.editTextQuantity.toString(),
                    binding.editTextDesi.toString(),
                    binding.editTextPrice.toString()
                )
